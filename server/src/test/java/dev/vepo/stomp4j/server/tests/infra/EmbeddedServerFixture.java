 ...
 * </p>
 * <ul>
 * <li><b>Knowing:</b> Ephemeral TCP and WebSocket ports bound by the embedded
 * server.</li>
 * <li><b>Doing:</b> Start and stop {@link StompServer} on allocated ports for
 * tests.</li>
 * </ul>
 * <p>
 * <b>Collaborators:</b> {@link EphemeralPorts}, {@link StompServer}
 * </p>
 * <p>
 * <b>Not responsible for:</b> protocol assertions or destination naming.
 * </p>
 */
